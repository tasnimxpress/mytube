...
export async function addLocalCourse(generateCourseId) {
    ...
    if (allItemsCheck.length > 500) {
        throw new Error(`This folder contains ${allItemsCheck.length} files. Please select a folder with 500 files or fewer to avoid browser memory issues.`)
    }
